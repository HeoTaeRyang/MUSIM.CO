...
const Signup = () => {
  ...
  const handlePassword_confirmChange = (event: ChangeEvent<HTMLInputElement>) => {
...
const handleSearchAddress = () => {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try {
       const response = await fetch('http://localhost:5000/register', { // <--- 이 부분을 수정!
        method: 'POST',
        headers: {
  ...
  return (
    <div className="signup-frame">
      ...
      <table>
        <tbody> {/* table 자식으로는 반드시 tbody, thead, tfoot 중 하나가 와야 합니다. */}
          <tr>
            <td>
          ...
          <tr>
            ...
            <td style={{ width: "700px" }}>
              <div className="input-box id-input">
                <input type="text" value={userid} onChange={handleUseridChange} /> {/* id -> userid, handleIdChange -> handleUseridChange */}
              </div>
          ...
          <tr>
            ...
            <td style={{ width: "700px" }}>
              <div className="input-box name-input">
                <input type="text" value={username} onChange={handleUsernameChange} /> {/* name -> username, handleNameChange -> handleUsernameChange */}
              </div>
            </td>
          </tr>
        </tbody>
          ...
          <tr>
            ...
            <td style={{ width: "150px" }}>
              <div className="input-box phone1-input">
                <select value={telPrefix} onChange={handleTelPrefixChange}> {/* tel1 -> telPrefix, handleTel1Change -> handleTelPrefixChange */}
            ...
            <td style={{ width: "150px" }}>
              <div className="input-box phone2-input">
                <input type="number" value={telMiddle} onChange={handleTelMiddleChange} /> {/* tel2 -> telMiddle, handleTel2Change -> handleTelMiddleChange */}
              </div>
            </td>
            -
            <td style={{ width: "150px" }}>
              <div className="input-box phone3-input">
                <input type="number" value={telSuffix} onChange={handleTelSuffixChange} /> {/* tel3 -> telSuffix, handleTel3Change -> handleTelSuffixChange */}
              </div>
            </td>
          </tr>
        </tbody>
          ...
          <tr>
            ...
            <td style={{ width: "150px" }}>
              <div className="input-box mobile1-input">
                <select value={phonePrefix} onChange={handlePhonePrefixChange}> {/* mobile1 -> phonePrefix, handleMobile1Change -> handlePhonePrefixChange */}
                  <option value="">선택</option>
            ...
            <td style={{ width: "150px" }}>
              <div className="input-box mobile2-input">
                <input type="number" value={phoneMiddle} onChange={handlePhoneMiddleChange} /> {/* mobile2 -> phoneMiddle, handleMobile2Change -> handlePhoneMiddleChange */}
              </div>
            </td>
            -
            <td style={{ width: "150px" }}>
              <div className="input-box mobile3-input">
                <input type="number" value={phoneSuffix} onChange={handlePhoneSuffixChange} /> {/* mobile3 -> phoneSuffix, handleMobile3Change -> handlePhoneSuffixChange */}
              </div>
            </td>
          </tr>
        </tbody>
      ...
      <table style={{ display: "block", margin: "0 auto" }}>
        <tbody>
          <tr>
            ...
            <td style={{ width: "450px", height: "100px" }}>
              <div className="signup-button" onClick={handleSubmit}>가입하기</div>
            </td>
          </tr>
        </tbody>
      </table>
